...
export function IconFolderOutline({ size = 18 }) {
  return (
...
export function IconHelp({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" aria-hidden="true">
      ...
      <path d="M9.5 9.5a2.5 2.5 0 1 1 3.6 2.2c-.8.4-1.6 1.1-1.6 2.3" />
...
export function IconApps({ size = 20 }) {
  return (
...
export function IconChevron({ size = 14, direction = 'down' }) {
...
export function IconPin({ size = 14 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M14.5 3.5 20.5 9.5 15 15l-1.5 5.5L8 15 3.5 10.5 9 5l5.5-1.5Z" opacity=".9" />
    </svg>
  )
}

export function IconBulb({ size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M9 18h6M10 21h4" />
      <path d="M8.5 14c-.8-1-1.5-1.8-1.5-3.5a5 5 0 1 1 10 0c0 1.7-.7 2.5-1.5 3.5-.5.6-.5 1.2-.5 2H9c0-.8 0-1.4-.5-2Z" />
    </svg>
  )
}
...
export function IconShare({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <path d="M11 10.5 16 8M11 13.5l5 2.5" />
...
export function IconPen({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M12 20h9" />
